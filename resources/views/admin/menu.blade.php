        ...
        <div class="row">
            <div class="card col-12">
                ...
                <div class="card-body">
                    ...
                    <div class="card">
                        <input class="btn btn-success" type="button" value="Tambah Menu" data-toggle="modal" data-target="#tambah">
                    </div>
                    <!-- /# card -->

                    <div class="section-title mt-0">10 Menu Terbaru</div>
                    <table class="table table-striped">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a class="btn" data-toggle="modal" data-target="#edit-{{$item->id}}"><i class="fa fa-edit"></i></a>
            ...
            <div class="modal-body">
                <form method="POST" enctype="multipart/form-data" action="{{ route('admin.edit',$item->id) }}">
                    ...
                    <div class="form-group">
                        ...
                        <input type="file" class="form-control @error('photo') is-invalid @enderror" name="photo" value="{{ 'storage/app/public/'. $item->photo }}">
                    ...
                    <div class="form-group">
                        <img src="{{ 'storage/app/public/'. $item->photo }}" height="40%" width="40%"> </img>
                    </div>
                    <div class="modal-footer">
                        <button type="submit" class="btn btn-md btn-primary">Simpan</button>
                        <button type="button" class="btn btn-secondary" data-dismiss="modal">Cancel</button>
