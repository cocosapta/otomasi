                        ...
                        <div class="invoice">
                                            ...
                                            <table class="table table-striped table-hover table-md">
                                                ...
                                                <form action="{{url('order.tambah',$item->id)}}" method="POST">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-right">
                                                            <!-- <div class="btn" onclick="handleCounterPlus()"><i class="fa fa-plus" style="color: blue;"></i></div> -->
                                                            <input style="width:50px;" type="number" name="total" min="1" class="counter" value="{{old('total',$item->total)}}" id="counter">
                                                            <!-- <div class="btn" onclick="handleCounterMinus()"><i class="fa fa-minus" style="color: blue;"></i></div> -->
                                                        </td>
                                                        ...
                                                        <td class="text-right">
                                                            <button class="btn " type="submit">
                                                                ...
                                                                Ubah Jumlah/Qty</button>
                                                            <a href="{{url('order.hapus',$item->id)}}" class="btn " type="submit"><i class="fa fa-trash" style="color: red;"></i>
                                                            Hapus </a>
                                                        </td>
                                                    </tr>
                                                </form>
                            ...
                            <div class="text-md-right">
                                <div class="float-lg-left mb-lg-0 mb-3">
                                    <a href="{{url('menu.order')}}" class="btn btn-primary btn-icon icon-left"><i class="fas fa-plus"></i> Tambah Menu Lain</a>
                                </div>
                                <form action="{{url('order.checkout')}}" method="POST">
                                    @csrf
                                    <input type="hidden" value=" {{ Auth::user()->id_user }}" name="id_user">
                                    <button class="btn btn-success btn-icon icon-left"><i class="fas fa-check"></i>Pesan ke Kasir</button>
                                </form>
                            </div>
                        </div>
                    </div>
