                    ...
                    <div
                        ...
                        <div class="login-brand">
                            <a href="{{ route('logout') }}"
                                ...
                                <img src="{{ asset('template/') }}/assets/img/stisla-fill.svg" alt="logo"
                        ...
                        <div class="card card-primary">
                            <div class="card-header">
                                <h4>Hi {{ Auth::user()->customer }} </h4>
                            </div>

                            <div class="card-body">
                                <p>Terima kasih atas kunjungannya ke restoran kami semoga harimu menyenangkan</p>
                                <br>
                                <form action="{{url('kode')}}" method="POST">
                                    @csrf
                                    <div class="form-group">
                                        <a href="{{ url('menu.order') }}" class="btn btn-primary " tabindex="4">Pesan
                                            lagi
                                        </a>
